...
import { addRooms, createInquiry, deleteRoomById, getAllInquiries, getReviews, getRooms, getRoomsById, requestMail, userReviews } from '../controller/rooms.controller.js';
...
router.post('/getAllInquiries', getAllInquiries);
